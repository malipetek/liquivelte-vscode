...
const addAttributes = {
    ...
    input: [
        ...
        Object.assign(Object.assign({}, indeterminateAttribute), { name: 'bind:indeterminate' })
    ],
...
const html5Tags = webCustomData_1.htmlData.tags.map((tag) => {
    ...
    return Object.assign(Object.assign({}, tag), { attributes });
});
...
function mapToSvelteEvent(attr) {
    return Object.assign(Object.assign({}, attr), { name: attr.name.replace(/^on/, 'on:') });
}
